...
Map favoriteFlush = {
  'Your gallery will look better with this addition' : '📸🖼️',
  'Take your socks out in bed 🧦': 'Advise from a friend 👨‍🏫',
  'Even that one would have made Kayne laugh 😹' : 'Nothing make kayne laugh 🐈',
  'Stop procastinating... 👁️👁️' : '..just kidding 👀',
  "Random Fact: I hope when I die it's early in the morning ☠️": "I don't want to go to work for no reason 🤷 ",
  "Aunti Marta would agree too 👵" : "And she doesn't even have a sense of humour 👵",
  "You like that one, hun!!" : "😏😏😏",
